...
class Pembeli extends user {
    ...
    public function get_transaksi_by_username($id_username) {
        $sql = "SELECT obat.nama_obat, obat.gambar, detail_pembelian.jumlah, detail_pembelian.harga, detail_pembelian.total, detail_pembelian.sisa_saldo,  detail_pembelian.tanggal_transaksi
    ...
    public function transaksi($id_pembeli, $id_obat, $jumlah, $harga, $total, $saldo, $sisa_saldo) {
        ...
        if($result) {
            ...
            header('location: ../../View/User/Transaksi_View/daftar_beli.php');
        } else {
